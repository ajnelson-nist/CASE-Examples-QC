...
1 | `Contained_Within` | <ul><li>`uco-core:Relationship`</li></ul> | `True` | <ul><li>`uco-location:Location`</li></ul> | <ul><li>`uco-observable:File`</li></ul> | <ul></ul>
1 | `Contained_Within` | <ul><li>`uco-core:Relationship`</li></ul> | `True` | <ul><li>`uco-observable:ContentData`</li></ul> | <ul><li>`uco-observable:ContentData`</li></ul> | <ul></ul>
...
5 | `Contained_Within` | <ul><li>`uco-observable:ObservableRelationship`</li></ul> | `True` | <ul><li>`uco-observable:DiskPartition`</li></ul> | <ul><li>`uco-observable:Disk`</li><li>`uco-observable:StorageMedium`</li></ul> | <ul></ul>
...
1 | `Contained_Within` | <ul><li>`uco-observable:ObservableRelationship`</li></ul> | `True` | <ul><li>`uco-observable:SIMCard`</li></ul> | <ul><li>`uco-observable:File`</li><li>`uco-observable:ObservableObject`</li></ul> | <ul><li>`drafting:TableRelationFacet`</li><li>`uco-core:Facet`</li><li>`uco-observable:DataRangeFacet`</li></ul>
...
2 | `Contained_Within` | <ul><li>`uco-observable:ObservableRelationship`</li></ul> | `True` | <ul><li>`uco-observable:URLHistory`</li></ul> | <ul><li>`uco-observable:File`</li></ul> | <ul><li>`drafting:TableRelationFacet`</li><li>`uco-core:Facet`</li><li>`uco-observable:DataRangeFacet`</li></ul>
...
1 | `Has_Account` | <ul><li>`uco-core:Relationship`</li></ul> | `True` | <ul><li>`uco-identity:Identity`</li></ul> | <ul><li>`uco-observable:ApplicationAccount`</li></ul> | <ul></ul>
1 | `Has_Account` | <ul><li>`uco-core:Relationship`</li></ul> | `True` | <ul><li>`uco-identity:Identity`</li></ul> | <ul><li>`uco-observable:EmailAccount`</li></ul> | <ul></ul>
3 | `Has_Account` | <ul><li>`uco-core:Relationship`</li></ul> | `True` | <ul><li>`uco-identity:Person`</li></ul> | <ul><li>`uco-observable:DigitalAccount`</li></ul> | <ul></ul>
3 | `Has_Account` | <ul><li>`uco-core:Relationship`</li></ul> | `True` | <ul><li>`uco-identity:Person`</li></ul> | <ul><li>`uco-observable:EmailAccount`</li></ul> | <ul></ul>
...
5 | `Has_Operating_System` | <ul><li>`uco-observable:ObservableRelationship`</li></ul> | `True` | <ul><li>`uco-observable:Device`</li></ul> | <ul><li>`uco-observable:OperatingSystem`</li><li>`uco-observable:Software`</li></ul> | <ul></ul>
3 | `Has_Operating_System` | <ul><li>`uco-observable:ObservableRelationship`</li></ul> | `True` | <ul><li>`uco-observable:MobileDevice`</li></ul> | <ul><li>`uco-observable:OperatingSystem`</li><li>`uco-observable:Software`</li></ul> | <ul></ul>
1 | `Has_Operating_System` | <ul><li>`uco-observable:ObservableRelationship`</li></ul> | `True` | <ul><li>`uco-observable:SIMCard`</li></ul> | <ul><li>`uco-observable:OperatingSystem`</li><li>`uco-observable:Software`</li></ul> | <ul></ul>
...
1 | `Referenced_Within` | <ul><li>`uco-observable:ObservableRelationship`</li></ul> | `True` | <ul><li>`uco-observable:SIMCard`</li></ul> | <ul><li>`uco-observable:File`</li><li>`uco-observable:ObservableObject`</li></ul> | <ul><li>`drafting:TableRelationFacet`</li><li>`uco-core:Facet`</li><li>`uco-observable:DataRangeFacet`</li></ul>
...
1 | `Used` | <ul><li>`uco-observable:ObservableRelationship`</li></ul> | `True` | <ul><li>`uco-observable:Computer`</li></ul> | <ul><li>`uco-observable:OperatingSystem`</li><li>`uco-observable:Software`</li></ul> | <ul></ul>
